    ...
    <div class="row"> 
        ...
        <div class="col-lg-4 col-12 mb-4">
            <div class="card bg-gray-100 py-2">
                <div class="card-body ">
                    <div class="row no-gutters align-items-center">
                        <div class="col-lg-12 rata-tengah text-right">
                            ...
                            <div class="ml-3 px-3 box-angka bg-orange text-white shadow-dark">
                                <p class="m-0"><b>Total</b></p>
                                <h4 class="m-0 ml-3 font-weight-bold">{{ $jml_total }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card bg-gray-100 py-2">
                <div class="card-body ">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-lg-11 rata-kanan text-right">
                            <div class="px-3" style="border-right: 1px solid #555;">
                                <div class="text-xs mb-1">
                                    Kotor
                                </div>
                            ...
                            <div class="ml-3 px-3 box-angka bg-success text-white shadow-dark rata-kanan">
                                <div>
                                    <p class="m-0">Untung Bersih</p>
                                    <h5 class="m-0 ml-3 font-weight-bold">Rp.{{ number_format($total_bersih, 0, ',', '.') }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
